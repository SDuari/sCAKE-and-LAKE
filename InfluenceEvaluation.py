...
outputdirectory = '/path/to/Word-scores-<algo>/' # Provide path to output Directory where the scores get saved, replace <algo> with either sCAKE or LAKE
...
if __name__=='__main__':
    # write_edgelistweighted(sys.argv[1])
